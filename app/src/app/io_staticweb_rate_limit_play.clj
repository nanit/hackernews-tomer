...
; Define redis limit
(def r-limit (ip-email-rate-limit :limit-id 5 (java.time.Duration/ofSeconds 10)))

; Define redis middleware
(def r-rate-limit-config {:storage redis-storage :limit r-limit :response-builder custom-response-builder})
